...
typedef void (*my_glDrawArraysEXT_FUNC)(GLenum mode, GLint first, GLsizei count);

my_glDrawArraysEXT_FUNC my_glDrawArraysEXT;
...
public:
	...
	void getGLExtension() {
		...
		if (strstr(ext.c_str(), "GL_EXT_vertex_array")) {
			my_glDrawArraysEXT = reinterpret_cast<my_glDrawArraysEXT_FUNC>(wglGetProcAddress("glDrawArraysEXT"));
		}
	}
